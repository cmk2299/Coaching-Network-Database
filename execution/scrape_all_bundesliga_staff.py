#!/usr/bin/env python3
"""
Scrape ALL coaching staff from Bundesliga clubs
Targets: Head Coaches, Co-Trainer, U23, U19, U17 trainers
"""
...
def main():
    print("=" * 70)
    print("BUNDESLIGA COACHING STAFF MASS SCRAPING")
    print("=" * 70)
    print(f"Target: {len(BUNDESLIGA_CLUBS)} clubs")
    print(f"Estimated coaches: ~{len(BUNDESLIGA_CLUBS) * 6}")
    print("=" * 70)

    all_coaches = []
    clubs_processed = 0

    for club_name, club_url in BUNDESLIGA_CLUBS.items():
        try:
